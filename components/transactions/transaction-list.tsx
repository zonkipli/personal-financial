...
export function TransactionList() {
  ...
  const filteredTransactions = transactions
    .filter((t) => {
      ...
      return matchesMonth && matchesYear && matchesType && matchesCategory && matchesSearch
    })
        ...
        <CardContent>
          {filteredTransactions.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-muted-foreground">Transaksi akan muncul di sini setelah Anda menambahkannya</p>
            </div>
          ) : (
